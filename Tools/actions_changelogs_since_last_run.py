...
CHANGELOG_FILES = [
    ...
    "Resources/Changelog/ChangelogStarshine.yml",
]  # Starshine-modified: "CHANGELOG_FILE" -> "CHANGELOG_FILES" and now contain several changelogs instead of one | Starshine-MultiChangelog
...
def main():
    ...
    for changelog_file in CHANGELOG_FILES: # Starshine-modified: added cycle for several changelog files | Starshine-MultiChangelog
        if DEBUG:
            ...
            last_changelog_stream = get_last_changelog(changelog_file) # Starshine-modified: added "changelog_file" into () | Starshine-MultiChangelog

        last_changelog = yaml.safe_load(last_changelog_stream)
        with open(changelog_file, "r") as f: # Starshine-modified: "CHANGELOG_FILE" -> "changelog_file" | Starshine-MultiChangelog
...
def get_last_changelog(changelog_file: str) -> str: # Starshine-modified | Starshine-MultiChangelog
    ...
    ) # Starshine-modified | Starshine-MultiChangelog
