...
ent-ClothingMaskBalaklava = balaklava
    .desc = A chunky fabric head cover that not only hides your face, but makes everyone put their money on the floor.
ent-ClothingMaskSyndieBalaklava = syndicate balaklava
    .desc = { ent-ClothingMaskBalaklava.desc }
ent-ClothingMaskRussianBalaklava = russian balaklava
    .desc = { ent-ClothingMaskBalaklava.desc }
