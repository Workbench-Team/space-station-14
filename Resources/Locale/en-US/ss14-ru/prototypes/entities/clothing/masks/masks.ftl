...
ent-ClothingMaskBalaklava = balaclava
    .desc = A chunky fabric head cover that not only hides your face, but makes everyone put their money on the floor.
ent-ClothingMaskSyndieBalaklava = syndicate balaclava
    .desc = { ent-ClothingMaskBalaclava.desc }
ent-ClothingMaskRussianBalaklava = russian balaclava
    .desc = { ent-ClothingMaskBalaclava.desc }
