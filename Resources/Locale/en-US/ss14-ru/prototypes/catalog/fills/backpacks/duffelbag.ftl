...
ent-ClothingBackpackDuffelSyndicateFilledSMG = C-20r bundle
    ...
    .suffix = { "" }
ent-ClothingBackpackDuffelSyndicateFilledRifle = KR51 bundle
    .desc = Hidden threat: The classic KR51 automatic rifle, bundled with three magazines.
    .suffix = { "" }
...
ent-ClothingBackpackDuffelSyndicateAmmoFilled = ammo bundle
    ...
    .suffix = { "" }
ent-ClothingBackpackDuffelSyndicateAmmoPistolFilled = boundle with pistol magazines (.35)
    .desc = A boundle of extended pistol magazines. 2 standard and 2 HV. Adaptation for Viper.
    .suffix = { "" }
ent-ClothingBackpackDuffelSyndicateAmmoPistolSubMachineGunBundle = boundle with SMG magazines (.35)
    .desc = A boundle containing magazines for SMG. 2 standard and 2 HV. Compatible with C-20r.
    .suffix = { "" }
ent-ClothingBackpackDuffelSyndicateAmmoShotGunBundle = boundle with shotgun magazines (.50)
    .desc = A boundle containing magazines for a shotgun. 2 standard, 2 bullet and 1 incendiary. Compatible with Bulldog.
    .suffix = { "" }
ent-ClothingBackpackDuffelSyndicateAmmoCaselessRifleBundle = boundle with rifle magazines (.25)
    .desc = A boundle containing magazines for a rifle. 2 standard and 2 HV. Compatible with KR51.
    .suffix = { "" }
