...
reagent-desc-cosmopolitan = Даже в самой плохой ситуации ничто не сравнится со свежим космополитом.
...
reagent-name-irish-slammer = ирландская тюряга
...
reagent-desc-the-martinez = Легенда об Бегущем по лезвию. Помнят по напитку, забывают по пьяни.
...
reagent-desc-pina-colada = Пинта пина колады лучше, чем половина пинты пина колады!
...
reagent-desc-white-gilgamesh = Тошнотворная смесь молока и пива. Создает ощущение, будто вы сделаны из дерева.
