...
implanter-draw-failed = Вы пытаетесь извлечь имплант, но ничего не находите.
implanter-draw-failed-catastrophically = Имплантёр ничего не находит и катастрофически выходит из строя, впивая генетический материал в руку { $user }!
