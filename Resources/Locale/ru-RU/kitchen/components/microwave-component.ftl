...
microwave-component-interact-item-too-big = { CAPITALIZE($item) } не может поместиться в микроволновке из-за размера!
...
microwave-menu-footer-flavor-left = Не кладите электронные, металлические или живые объекты.
