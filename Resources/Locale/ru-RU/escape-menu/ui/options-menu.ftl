...
ui-options-vp-integer-scaling = Предпочитать целочисленное масштабирование (может вызвать появление чёрных полос/обрезание)
...
ui-options-function-reset-zoom = Сброс масштаба
