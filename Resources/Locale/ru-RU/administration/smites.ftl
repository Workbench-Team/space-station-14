...
admin-smite-electrocute-description = Поражает цель электрическим током, делая бесполезным все, что было на ней надето.
...
admin-smite-cluwne-description = Клувнирует цель. Костюм нельзя снять и экипаж станции может свободно убивать её.
...
admin-smite-reptilian-species-swap-description = Меняет ксеновид на Унатха. Пригодится для тех, кто ведёт себя как космический расист.
admin-smite-felinid-species-swap-description = Меняет ксеновид на Фелинида. Мяу!
admin-smite-moth-species-swap-description = Меняет ксеновид на Моль. Бззз!
