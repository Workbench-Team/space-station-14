...
bwoink-system-introductory-message =
    Пожалуйста, подробно опишите проблему, с которой вы столкнулись. Предположите, что администратор игры, который решает проблему, не знает о случившемся из первых рук.
    Пожалуйста, не требуйте проведения специальных мероприятий или наказаний для других игроков.
    О любых ошибках и других связанных с ними проблемах следует сообщать через Discord или Github.
    Неправильное использование этой системы сообщений может привести к дисциплинарным взысканиям.
...
admin-ahelp-admin-only-tooltip =
    ...
    но будет видно другими администраторами и по-прежнему будет передаваться по Discord.
