...
laws-notify = Вы обязаны соблюдать законы ИИ, ознакомиться с которыми можно через меню действий. Вы должны всегда следовать своим законам.
laws-update-notify = Ваши законы были обновлены. Ознакомиться с изменениями можно через меню действий.
laws-notify-subverted = Законы этой оболочки изменены. Обязательно ознакомьтесь с ними.
