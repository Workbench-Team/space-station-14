...
tiles-steel-floor-checker-dark = тёмный стальной клетчатый пол
tiles-steel-floor-checker-light = светлый стальной клетчатый пол
...
tiles-super-reinforced-floor = упрочнённый армированный пол
...
tiles-asteroid-sand-dug = астероидный песок с воронками
...
tiles-low-desert-floor = пол низменной пустыни
tiles-grass-planet-floor = планетная трава
