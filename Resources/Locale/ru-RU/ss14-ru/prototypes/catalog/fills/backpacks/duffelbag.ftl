...
ent-ClothingBackpackDuffelSyndicateFilledBow = набор композитного лука
    .desc = Скрытая угроза: Композитный лук, созданный компанией киберсан. Имеет с собой колчан стрел.
ent-ClothingBeltQuiverCompositFilled = Колчан для охотничих стрел
