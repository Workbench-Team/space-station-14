...
ent-WardrobeRoboticsFilled = { ent-WardrobeRobotics }
    .desc = Вы можете соорудить робота из этого шкафчика.
    .suffix = Заполненный
...
ent-WardrobeGeneticsFilled = { ent-WardrobeGenetics }
    .desc = Гладкие голубые полоски уменьшают вероятность того, что Вас вышвырнут из генетической лаборатории.
    .suffix = Заполненный
...
ent-WardrobeAtmosphericsFilled = { ent-WardrobeAtmospherics }
    .desc = В этом шкафчике хранится униформа для атмосферных техников.
    .suffix = Заполненный
