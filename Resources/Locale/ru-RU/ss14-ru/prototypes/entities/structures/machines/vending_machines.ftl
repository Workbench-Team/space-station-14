...
ent-VendingMachineBooze = АлкоМат
    .desc = Чудо технологической мысли, по замыслу способное смешать именно ту смесь, которую вВ хотите выпить, стоит Вам только попросить.
    .suffix = { "" }
...
ent-VendingMachineChemicals = ХимШкаф
    .desc = Точно не кофе-машина.
    .suffix = { "" }
