...
ent-SyndicateComputerComms = коммуникационная консоль синдиката
    .desc = Компьютер, способный удаленно взламывать системы связи станции. Используя его для объявления, вы предупредите станцию о своём присутствии.
ent-WizardComputerComms = коммуникационная консоль волшебников
    .desc = Компьютер, способный волшебным образом проецировать вашу речь на станцию. Используя его для объявления, вы предупредите станцию о своём присутствии.
ent-CentcommComputerComms = коммуникационная консоль центрального командования
    .desc = Компьютер, используемый для объявлений по всему миру с клавиатуры. Старший двоюродный брат обычного коммуникационной консоли.
...
ent-ComputerSalvageExpedition = консоль экспедиций шахтеров
    .desc = Используется для выполнения миссий шахтеров.
