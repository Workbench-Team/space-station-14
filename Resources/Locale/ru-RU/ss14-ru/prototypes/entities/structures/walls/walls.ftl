...
ent-WallForce = силовой барьер
    .desc = { "" }
ent-WallCobblebrick = стена из булыжной кладки
    .desc = Идеально подогнанные друг к другу кирпичик за кирпичиком образовали стену.
ent-WallBasaltCobblebrick = стена из базальтовой кладки
    .desc = { ent-WallCobblebrick.desc }
ent-WallSnowCobblebrick = стена из снежной кладки
    .desc = Холодная, не такая уж непроходимая стена.
ent-WallAsteroidCobblebrick = стена из астероидной кладки
    .desc = { ent-WallCobblebrick.desc }
ent-WallSandCobblebrick = стена из песчаниковой кладки
    .desc = { ent-WallCobblebrick.desc }
ent-WallChromiteCobblebrick = стена из хромитовой кладки
    .desc = { ent-WallCobblebrick.desc }
ent-WallAndesiteCobblebrick = стена из андезитовой кладки
    .desc = { ent-WallCobblebrick.desc }
