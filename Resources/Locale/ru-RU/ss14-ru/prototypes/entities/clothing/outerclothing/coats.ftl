...
ent-ClothingOuterCoatDetectiveLoadoutGrey = нуарный тренчкот
    .desc = Ах, ваш верный тренчкот. Пара прорех тут и там придают ему более соответствующий детективу вид. По крайней мере, так вы сказали себе, когда узнали, что починка обойдётся вам в 200 космобаксов.
...
ent-ClothingOuterCoatLabSeniorResearcher = лабораторный халат инструктора-учёного
    .desc = Халат, защищающий от небольших разливов химикатов. Имеет фиолетовый воротник и отделку на запястьях.
ent-ClothingOuterCoatLabSeniorResearcherOpened = лабораторный халат учёного-инструктора
...
ent-ClothingOuterCoatLabSeniorPhysicianOpened = лабораторный халат врача-инструктора
    .desc = { ent-ClothingOuterStorageFoldableBaseOpened.desc }
