...
ent-ClothingOuterWinterMusician = зимнее пальто музыканта
    ...
    .suffix = { "" }
ent-ClothingOuterWinterOfficerUEG1 = пальто Офицера ОПЗ.
    .desc = Длинное и изящное пальто офицера ОПЗ, показывающее значимость и ранг человека что его надел.
    .suffix = { "" }
ent-ClothingOuterWinterOfficerUEG2 = меховое пальто Офицера ОПЗ.
    .desc = Длинное меховое пальто офицера ОПЗ, выглядит тепло и значимо. Похоже, оно очень нравится девушкам.
    .suffix = { "" }    
ent-ClothingOuterWinterOfficerUEG3 = куртка Офицера ОПЗ.
    .desc = Плотная куртка офицера ОПЗ. 
    .suffix = { "" }
ent-ClothingOuterWinterOfficerUEG4 = меховая куртка Офицера ОПЗ.
    .desc = Тёплая куртка для офицера ОПЗ. Предназначенная для того, чтобы спасти вас от холода.
    .suffix = { "" }
