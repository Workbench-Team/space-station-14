...
ent-FoodSnackCnDs = C&D
    .desc = С юридической точки зрения, мы не можем утверждать, что это не растает в ваших руках.
...
ent-FoodSnackPistachios = сладкие фисташки
    .desc = Фисташки торговой марки "Сладкоежка". возможно, не вызовут у вас заболеваний. Возможно.
