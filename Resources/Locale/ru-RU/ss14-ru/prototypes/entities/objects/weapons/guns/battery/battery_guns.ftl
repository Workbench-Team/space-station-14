...
ent-WeaponAntiqueLaser = антикварный лазерный пистолет
    .desc = Это антикварный лазерный пистолет. Все детали выполнены в высочайшем качестве. Рукоятка украшена хромированной филигранью. Предмет устрашает энергетическими всплесками. На нём изображены капитан и клоун. Клоун мертв. Капитан принимает героическую позу.
    .suffix = Пистолет
