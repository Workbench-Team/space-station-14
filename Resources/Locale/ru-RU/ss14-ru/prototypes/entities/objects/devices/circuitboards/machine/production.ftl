...
ent-WeaponTechFabCircuitboard = оружейный ТехФаб (машинная плата)
...
ent-BiogeneratorMachineCircuitboard = биогенератор (машинная плата)
    .desc = Печатная печатная плата для биогенератора.
...
ent-SMESAdvancedMachineCircuitboard = продвинутый СМЭС (машинная плата)
    .desc = Печатная плата для продвинутого СМЭС'а.
