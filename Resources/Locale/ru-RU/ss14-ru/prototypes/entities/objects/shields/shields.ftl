...
ent-RiotLaserShield = противолазерный щит
    .desc = Щит, созданный противостоять лазерам, но не более того.
ent-RiotBulletShield = баллистический щит
    .desc = Щит, созданный для защиты от баллистических снарядов, но не более того.
...
ent-WebShield = паутинный щит
    .desc = Вязкий щит. Слабый и не очень огнестойкий.
