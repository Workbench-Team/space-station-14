...
ent-AnomalyScannerRD = сканер аномалий научного руководителя
    .desc = Ручной сканер, предназначенный для сбора информации о различных аномальных объектах. Усовершенствован, специально для научного руководителя.
