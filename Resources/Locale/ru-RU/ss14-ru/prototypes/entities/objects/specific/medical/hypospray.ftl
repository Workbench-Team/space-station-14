...
ent-StimpackMini = микроинъектор гиперзина
    .desc = Микроинъектор гиперзина, который дает Вам примерно 15 секунд воздействия химического вещества.
...
ent-WehMedipen = автоинъектор вех
    .desc = Быстрая доза Вех. Содержит сок, который заставляет вас вехать.
