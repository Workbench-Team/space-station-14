...
ent-RadioImplant = радиоимплант
    .desc = Этот имплант даёт доступ к каналу Синдиката без гарнитуры.
...
ent-FakeMindShieldImplant = имплант поддельного щита разума
    .desc = Этот имплант позволяет пользователю генерировать поддельный сигнал, по которому NT визоры службы безопасности идентифицируют людей, имплантированных щитом разума.
...
ent-RadioImplantCentcomm = радиоимплант
    .desc = Этот имплант даёт доступ к каналу Центком без гарнитуры. Разрешён только сотрудникам Центкома.
