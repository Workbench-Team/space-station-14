...
uplink-stimkit-desc = Аптечка, содержащая 6 микро-инъекторов гиперзина, каждый из которых содержит дозу гиперзина на 15 секунд.
...
uplink-mobcat-microbomb-desc = Вызовите ручного кота, оснащенного имплантатом микробомбы. Взрывается при серьезном ранении. Может больно кусать.
