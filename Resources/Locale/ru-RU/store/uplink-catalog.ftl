...
uplink-pistol-magazine-bundle-desc = Набор, содержащий 4 стандартных расширенных магазина для пистолета. Подходит для Гадюки.
uplink-pistol-magazine-c20r-bundle-name = Набор с магазинами ПП (.35)
uplink-pistol-magazine-c20r-bundle-desc = Набор, содержащий 4 стандартных магазина для ПП. Совместим с C-20r.
...
uplink-quiver-composit-filled-name = Колчан охотничьих стрел
uplink-quiver-composit-filled-desc = Колчан, наполненный охотничьими стрелами. Содержит 40.
...
# Импланты
uplink-storage-implanter-name = Имплантат хранилища
...
uplink-stimkit-desc = Кейс для медипенов, содержащий 6 микроинъекторов стимуляторов, каждый из которых вводит Вам достаточное количество стимуляторов в течение минуты.
...
uplink-syndie-drobe-name = СиндиШкаф
uplink-syndie-drobe-desc = Крайне красивый, красный, торговый автомат только для самых стильных агентов.
