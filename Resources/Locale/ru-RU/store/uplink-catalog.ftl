...
uplink-hypereutactic-blade-desc = Гигантский энергетический меч, мощь которого соответствует его внешнему виду. Требует две руки. Медленный и неповоротливый, но довольно умелый в отражении. Ранее приобрел дурную славу из-за оперативника в маске радости. Вы бы не хотели увидеть, как он несётся на вас по коридору!
...
uplink-mini-bomb-desc = Маломощное, высокоэффективное точечное взрывное устройство для диверсий, с 5-исекундным взрывателем. Идеально подходит для быстрого уничтожения устройств, трупа или чего-либо ещё.
...
uplink-radio-implanter-name = Радиоимплантёр
...
uplink-chimp-upgrade-kit-name = Чип улучшения револьвера Ш.И.М.П.
uplink-chimp-upgrade-kit-desc = Вставьте этот чип в стандартный Ш.И.М.П., чтобы он смог стрелять омега-частицами. Омега-частицы причиняют сильные ожоги и способствуют переходу аномалий в сверхкритическое состояние.
...
uplink-fake-mindshield-desc = Переключаемый имплант, способный имитировать те же сигналы, что и настоящий щит разума. С его помощью можно обмануть визоры, заставив думать, что у вас есть щит разума (имплант марки Nanotrasen не прилагается).
