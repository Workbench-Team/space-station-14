department-Cargo-description = Выполняйте запросы, зарабатывайте космобаксы и доставляйте экипажу полезные припасы.
...
department-CentralCommand-description = Управляйте экипажем и обеспечивайте его эффективную работу.
