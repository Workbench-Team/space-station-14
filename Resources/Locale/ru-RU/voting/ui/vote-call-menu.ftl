...
ui-vote-type-votekick = Исключение игрока
# Votekick reasons
...
ui-vote-trusted-users-notice =
    Эта возможность голосования доступна только тем игрокам, которые имеют достаточно игрового времени или внесены в белый список.
    Кроме того, вы должны быть призраком в течение { $timeReq } секунд.
