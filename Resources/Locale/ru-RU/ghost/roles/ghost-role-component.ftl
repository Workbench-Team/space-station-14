...
ghost-role-information-loneop-rules = Вы [color=red][bold]Одинокий антагонист[/bold][/color]. Помощь агентов на станции не гарантируется.
...
ghost-role-information-medical-name = Врач
