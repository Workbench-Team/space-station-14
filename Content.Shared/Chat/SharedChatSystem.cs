...
public abstract class SharedChatSystem : EntitySystem
{
    ...
    public static readonly SoundSpecifier DefaultAnnouncementSound
        = new SoundPathSpecifier("/Audio/Starshine/Announcements/announce.ogg"); // Starshine-Announcements
    public static readonly SoundSpecifier CentComAnnouncementSound
        = new SoundPathSpecifier("/Audio/Starshine/Announcements/centcomm.ogg"); // Starshine-Announcements
